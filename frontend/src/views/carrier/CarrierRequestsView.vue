  ...
  <div class="page-stack">
    ...
    <section class="grid-2">
      <article class="panel">
        ...
        <form class="form-grid">
          ...
          <div class="field">
            ...
            <select id="workType">
              <option value="LOAD_OUT">
                반출 상차
              </option>

              <option value="UNLOAD_IN">
                반입 하차
              </option>
            </select>
          </div>
          ...
          <div class="field">
            ...
            <input
              id="workStatus"
              value="DISPATCH_WAITING"
            />
          </div>

          <button
            class="primary-button full request-button"
            type="button"
          >
            운송 요청 등록
          </button>
      ...
      <article class="panel">
        ...
        <div
          v-else-if="availableMyDrivers.length === 0"
          class="empty-box"
        >
          출입 가능한 소속 기사가 없습니다.
        </div>
