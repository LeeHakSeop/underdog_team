...
public class DriverController {
    ...
    @GetMapping("/carrier/{carrierUserId}/management")
    public List<CarrierDriverManagementDTO> carrierDriverManagement(
            @PathVariable Long carrierUserId
    ) {
        return driverService.managementListByCarrierUserId(carrierUserId);
    }
